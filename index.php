			...
			<div class="col-md-4">
				<div class="productbox">
					<div class="fadeshop">
						...
						<span class="maxproduct"><img src="<?=$img_front?>product1-1.jpg" alt=""></span>
					</div>
			...
			<div class="col-md-4">
				<div class="productbox">
					<div class="fadeshop">
						...
						<span class="maxproduct"><img src="<?=$img_front?>product2.jpg" alt=""></span>
					</div>
					<div class="product-details">
						<a href="#">
			...
			<div class="col-md-4">
				<div class="productbox">
					<div class="fadeshop">
						...
						<span class="maxproduct"><img src="<?=$img_front?>product2-3.jpg" alt=""></span>
					</div>
					<div class="product-details">
						<a href="#">
						<h1>Biscaya Theme</h1>
		...
		<div class="col-md-10 col-md-offset-1">
			<div class="slide-text">
				<div>
					...
					<img src="http://wowthemes.net/demo/salique/salique-boxed/<?=$img_front?>temp/avatar2.png" alt="Awesome Support">
					<p>
