...
<form class="form-horizontal" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group form-group-lg col-md-6 float-right">
                                        <label class="col-sm-2 col-md-12 control-label">Site Name</label>
                                    ...
                                    <!-- Start Email Field -->
                                    <div class="form-group form-group-lg col-md-6 float-left">
                                        <label class="col-sm-2 col-md-12 control-label">Site Email</label>
                                        <div class="col-sm-10 col-md-12">
                                    ...
                                    <!-- Start phone Field -->
                                    <div class="form-group form-group-lg col-md-6 float-right">
                                        <label class="col-sm-2 col-md-12 control-label">Site Phone</label>
                                        <div class="col-sm-10 col-md-12">
                                    ...
                                    <!-- Start address Field -->
                                    <div class="form-group form-group-lg col-md-6 float-left">
                                        <label class="col-sm-2 col-md-12 control-label">Site Address</label>
                                        <div class="col-sm-10 col-md-12">
                                    ...
                                    <!-- Start facebook url Field -->
                                     <div class="form-group form-group-lg col-md-6 float-right">
                                        <label class="col-sm-2 col-md-12 control-label">Facebook Url</label>
                                        <div class="col-sm-10 col-md-12">
                                    ...
                                    <div class="form-group form-group-lg col-md-6 float-left">
                                        <label class="col-sm-2 col-md-12 control-label">Twitter Url</label>
                                        <div class="col-sm-10 col-md-12">
                                    ...
                                    <div class="form-group form-group-lg col-md-6 float-right">
                                        <label class="col-sm-2 col-md-12 control-label">LinkedIn Url</label>
                                        <div class="col-sm-10 col-md-12">
                                    ...
                                    <div class="form-group form-group-lg col-md-6 float-left">
                                        <label class="col-sm-2 col-md-12 control-label">Whattsapp Url</label>
                                        <div class="col-sm-10 col-md-12">
                                    ...
                                    <div class="form-group form-group-lg col-md-6 float-right">
                                        <label class="col-sm-2 col-md-12 control-label">Site Description</label>
                                        <div class="col-sm-10 col-md-12">
                                ...
                                <!-- Start site tags Field -->
                                    <div class="form-group form-group-lg col-md-6 float-left">
                                        <label class="col-sm-2 col-md-12 control-label">Site Tags</label>
                                        <div class="col-sm-10 col-md-12">
                                            <textarea class="form-control" name="site_tags"><?=$row['site_tags']?></textarea>
                                        </div>
                                    </div>
                                    <!-- End site description Field -->
                                    <!-- Start site url Field -->
                                    <div class="form-group form-group-lg">
                                        <label class="col-sm-2 col-md-12 control-label">Site Main Link</label>
                                        <div class="col-sm-10 col-md-12">
                                            <input type="text" name="site_link" value="<?= $row['site_link'] ?>" class="form-control" required="required" />
                                        </div>
                                    </div>
                                    <!-- End site url Field -->
                                    <!-- Start site status Field -->
                                    <div class="form-group form-group-lg">
                                        <label class="col-sm-2 col-md-12 control-label">Site Status</label>
                                        <div class="col-sm-10 col-md-12">
                                    ...
                                    <div class="form-group form-group-lg col-md-6 float-right">
                                        <label class="col-sm-2 col-md-12 control-label">Site Close Text</label>
                                        <div class="col-sm-10 col-md-12">
                                    ...
                                    <div class="form-group form-group-lg col-md-6 float-left">
                                        <label class="col-sm-2 col-md-12 control-label">Site Copyrights</label>
                                        <div class="col-sm-10 col-md-12">
                                   ...
                                   <div class="clearifx"></div>
                                    ...
                                    <div class="col-md-6 float-left">
                                        <div class="form-group form-group-lg">
                                            <label class="col-sm-2 col-md-12 control-label">Site Fav Icon</label>
                                            <div class="col-sm-10 col-md-12">
                                     ...
                                     <div class="col-md-6 float-right">
                                         <div class="form-group form-group-lg">
                                            <label class="col-sm-4 col-md-12 control-label">Site Slider Background</label>
                                            <div class="col-sm-10 col-md-12">
