				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="#"><?=$user['username']?> Favourite List</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-lg-9 col-12">
							<div class="form-main">
								...
								<div class="title">
									<h4><?=$user['username']?> Favourite List</h4>
...
<script type="text/javascript">
          $(document).ready(function() {
            ...
            var t = $('#example').DataTable( {
              ...
              "serverSide": true,
              "targets": 0,
              "ajax": "users/server_processing.php?user_id="+user_id,
              "order": [[ 1, 'asc' ]]
            });
       ...
       function confirmationDel() {
              ...
              .then((willDelete) => {
                ...
                if (willDelete) {
                  ...
                  $.ajax({    
                    type: "POST",
                    data :{ids:ids_products,tblname:"favs"},
                    url: urlToRedirect, 
                    success: function(){   
                      swal("Poof! Your imaginary file has been deleted!", {
                        icon: "success",
